...
(
    ...
    id_fonctionnel SERIAL NOT NULL,
    nom                 VARCHAR(255) NOT NULL,
...
(
    id               UUID DEFAULT gen_random_uuid() PRIMARY KEY,
    id_traitement    UUID NOT NULL,
    id_etablissement UUID NOT NULL,
    CONSTRAINT fk_traitetab_traitement FOREIGN KEY (id_traitement) REFERENCES traitement (identifiant) ON DELETE CASCADE,
