...
public class RowFileToTraitement {
    ...
    public static TraitementDTO map(List<String> cellules, ClientDTO client, Integer version) {
            ...
            String dispositionExistanteSecuriteDonnees = cellules.get(26);
            String emplacementNumerique = cellules.get(27);
            // TODO: Voir pour ce champ en doublon en base, manque peut-être un champ spécifique "sécu donnée numérique"
//            String dispositionSecuriteDonnees = cellules.get(28);
            ...
            return new TraitementDTO(
                    id, nomTraitement, gestionnaireMiseEnOeuvre, finalitePrincipale, client, version,
                    ...
                    emplacementPhysiqueTraitement, dispositionExistanteSecuriteDonnees, emplacementNumerique, hebergement,
                    Integer.getInteger(dureeDeConservation), Boolean.parseBoolean(archivage), Integer.getInteger(dureeArchivage), categoriesDestinataires,
